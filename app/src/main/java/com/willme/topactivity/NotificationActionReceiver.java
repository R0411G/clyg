...
public class NotificationActionReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_NOTIFICATION_RECEIVER = "com.willme.com.willme.topactivity.ACTION_NOTIFICATION_RECEIVER";
    ...
    public static void showNotification(Context context, boolean isPaused) {
        ...
        PendingIntent
            pIntent = PendingIntent.getActivity(context, 0, new Intent(context, MainActivity.class), 0);
